...
function FixedExpenseForm({
  ...
  const [form, setForm] = useState({
    ...
    // Recurring fields
    isRecurring: editData?.isRecurring ?? true, // Default true for fixed expenses
    ...
    baseAmount: editData?.baseAmount || editData?.amount || "",
  });
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <FormInfoText>Your info text here for fixed expenses.</FormInfoText>
